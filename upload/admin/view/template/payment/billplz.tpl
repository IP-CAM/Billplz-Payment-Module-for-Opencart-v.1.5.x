                ...
                <table class="form">
                    ...
                    <tr>
                      ...
                      <td><select name="billplz_sandbox">
						  <?php $number11=array("https://www.billplz.com/api/v3/bills/","https://billplz-staging.herokuapp.com/api/v3/bills/");$idno=array("https://www.billplz.com/api/v3/bills/"=>"Production","https://billplz-staging.herokuapp.com/api/v3/bills/"=>"Sandbox"); foreach ($number11 as $idno3) { ?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="billplz_sort_order" value="<?php echo $billplz_sort_order; ?>" size="1" /></td>
                    </tr>
                </table>
            </form>
        </div>
